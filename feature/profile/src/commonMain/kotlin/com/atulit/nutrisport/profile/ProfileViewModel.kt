...
import com.atulit.nutrisport.shared.domain.Country
import com.atulit.nutrisport.shared.domain.Customer
import com.atulit.nutrisport.shared.domain.PhoneNumber
    ...
    val isFormValid: Boolean
        get() = with(screenState) {
            firstName.length in 3..50 &&
                    ...
                    address?.length in 3..150 &&
                    phoneNumber?.number?.length in 5..10
        }
